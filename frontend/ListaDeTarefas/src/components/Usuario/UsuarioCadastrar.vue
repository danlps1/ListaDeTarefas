  ...
  <div class="min-h-screen bg-gray-100">
    ...
    <main class="h-full w-full px-4 sm:px-0">
      <div class="flex justify-center flex-col items-center">
        <h1 class="text-4xl font-black text-gray-700 py-6">Cadastrar Usuário</h1>
      </div>
      ...
      <div class="flex justify-center flex-col items-center">
        <div class="bg-white min-w-[600px] border border-gray-200 shadow-md rounded-md overflow-hidden">
          ...
          <div class="flex flex-col items-center p-4">
            <label class="font-medium mb-1">Nome do usuário </label>
            <form @submit.prevent>
              <input type="text"
...
export default {
  ...
  setup: function () {
    ...
    const cadastrarUsuario = async (): Promise<void> => {
      try {
        const usuario: Usuario = {nome: nomeUsuario.value};
